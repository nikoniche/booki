...
import com.booki.book_search.apis.openLibrary.OpenLibrary
...
class SearchViewModel: ViewModel() {
    data class Search(
        ...
        var result: MutableList<com.booki.Book> = mutableListOf(),
        var error: String="",
    )
    ...
    private fun extendResultsList(listToAdd: List<com.booki.Book>) {
...
//                    )
                    ...
                    val matchingUserBooks: MutableList<com.booki.Book> = mutableListOf()
                    userBooks.forEach {
    ...
    fun fetchUserBook(userBook: com.booki.Book) {
        _search.value = Search()
        _search.value = _search.value.copy(
